...
// author: Tarun Verma
	...
	public static boolean dfsCycle(int node, int par, boolean vis[], int n) {
		vis[node] = true;
		for(int i: adj[node]) {
			if(!vis[i]) {
				if(dfsCycle(i, node, vis, n)) return true;
			} else if(i != par) {
				return true;
			}
		}
	...
	public static void solve() {
		...
		if(isCycle(vis, n)) System.out.println("Cycle");
